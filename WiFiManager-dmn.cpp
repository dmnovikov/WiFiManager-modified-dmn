...
boolean WiFiManager::autoConnect(char const *apName, char const *apPassword) {
  ...
  return startConfigPortal(apName, apPassword, NULL, NULL);
}
...
boolean WiFiManager::startConfigPortal() {
  String ssid = "ESP" + String(ESP.getChipId());
  return startConfigPortal(ssid.c_str(), NULL, NULL, NULL);
}

boolean  WiFiManager::startConfigPortal(char const *apName, char const *apPassword, String *__ssid, String *__pass) {
  ...
  while(1){
    ...
    if (connect) {
      connect = false;
      delay(2000);
      DEBUG_WM(F("GOT NEW SSID and PASS, FINISH"));
      *__ssid=_ssid;
      *__pass=_pass;
